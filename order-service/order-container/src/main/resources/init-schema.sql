/*This file is pointed to from the application.yml datasource:schema:classpath:init-schema.sql*/
DROP SCHEMA IF EXISTS "order" CASCADE;

CREATE SCHEMA "order";
/*Allows for  use of uuid in PostgreSQL*/
...
(
    ...
    /* use of order id and id allows for both a primary key and the uniqueness of an order item*/
    CONSTRAINT order_items_pkey PRIMARY KEY (id, order_id)
);

/*Creation of Foreign key in order_items for use in primary key is carried out below*/
