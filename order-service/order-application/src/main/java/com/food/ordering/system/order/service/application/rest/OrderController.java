...
/**
 * OrderApplicationServiceImpl from order-domain module made available via constructor dependency injection of its
 * interface
 *
...
/**
 * On successfully creating an order return a Spring ResponseEntity  [200] along with createOrderResponse that is
 * created
...
/**
 * Happy Path: Given a trackingId for an existing order a @Transactional(readOnly=true) returns an order that has its
 * details mapped
