...
public class RestaurantApprovalOutboxScheduler implements OutboxScheduler {
  ...
  public RestaurantApprovalOutboxScheduler(
      ...
      final RestaurantApprovalRequestMessagePublisher restaurantApprovalRequestMessagePublisher) {
  ...
  public void processOutboxMessage() {
    ...
    if (outboxMessagesResponse.isPresent() && outboxMessagesResponse.get().size() > 0) {
      ...
      log.info(
          ...
          outboxMessagesResponse.get().size(),
      ...
      outboxMessages.forEach(outboxMessage -> restaurantApprovalRequestMessagePublisher.publish(outboxMessage,
              ((orderApprovalOutboxMessage, outboxStatus) -> updateOutboxStatus(orderApprovalOutboxMessage, outboxStatus))));
