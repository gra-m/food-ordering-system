...
public class OrderCreateHelper
{
    ...
    /**
     * Info: Transactional , Spring proxy AOP, has to be invoked through a proxy, i.e. another bean also
     * Transactional must
     * be
    ...
    /**
     * For Refactor copied from OrderCreateCommandHandler Given that a CreateOrderCommand has been received, it will
     * be used
