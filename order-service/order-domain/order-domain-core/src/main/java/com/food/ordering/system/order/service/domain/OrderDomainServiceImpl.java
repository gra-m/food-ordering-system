...
public class OrderDomainServiceImpl implements OrderDomainService
{
     ...
     * Again the need for a specific cast RestaurantId extends BaseId && BaseEntity&lt;BaseId&gt; not required in eg.
     * code
     *
    ...
    /**
     * Given that the orderItems may have been populated with out-of-date information it is necessary to go to the
     * database
