...
public class PaymentDomainServiceImpl implements PaymentDomainService
{
    ...
    /**
     * Given that the payment objects are in the correct state this method will not error, that is the credit history
     * for
     * the customer <i>is</i> equal to the current credit for this customer id <i>and</i> totalDebitHistory <i>is
     * not</i>
