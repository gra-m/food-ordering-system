...
public class Restaurant extends AggregateRoot<RestaurantId>
{
    ...
    /**
     * Given that an order is @ OrderStatus.PAID and all products required to fulfill order are available and the
     * confirmed
    ...
    public void validateOrder(List<String> failureMessages)
    {
        ...
        if (orderDetail.getOrderStatus() != OrderStatus.PAID) {
            failureMessages.add(String.format("Payment is not completed for order: %s",
