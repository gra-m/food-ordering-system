...
"{\"type\":\"record\",\"name\":\"Product\",\"namespace\":\"com.food.ordering.system.kafka.order.avro.model\"," +
"\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"quantity\"," +
"\"type\":\"int\"}]}");
...
( org.apache.avro.io.DatumWriter<Product> ) MODEL$.createDatumWriter(
SCHEMA$);
@SuppressWarnings("unchecked")
private static final org.apache.avro.io.DatumReader<Product> READER$ =
( org.apache.avro.io.DatumReader<Product> ) MODEL$.createDatumReader(
SCHEMA$);
 ...
 */
@org.apache.avro.specific.AvroGenerated
public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Product> implements org.apache.avro.data.RecordBuilder<Product> {
