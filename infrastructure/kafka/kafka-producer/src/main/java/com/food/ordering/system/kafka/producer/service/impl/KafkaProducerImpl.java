...
/**
 *
 * A message is sent to topic asynchronously, the ListenableFuture has the SendResult added to it as a callback, resolving
...
public void send(String topicName, K key, V message, ListenableFutureCallback<SendResult<K, V>> callback) {
      ...
      try {
            ...
            throw new KafkaProducerException(String.format("Error on kafka producer with key: %s and message: %s", key, message), e);
      }
